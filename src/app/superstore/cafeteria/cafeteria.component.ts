...
@Component({
  ...
  styleUrls: ['./cafeteria.component.css', '../style/common.css']

})
export class CafeteriaComponent extends ProductBase implements AfterViewInit {
  ...
  public async getProducts(): Promise<void> {
    ...
    this.httpGetProductList('cafetab', 1);
  }
}
